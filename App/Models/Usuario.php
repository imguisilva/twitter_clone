...
class Usuario extends Model{
    ...
    public function validarCadastro(){
        ...
        if(strlen($this->__get('nome')) < 3){ //só vai permitir a criação usuario caso o nome tenha mais de 3 caracteres
            $valido = false;
        }
    ...
    public function getUsuarioPorEmail(){
        ...
        return $stmt->fetchAll(\PDO::FETCH_ASSOC); //vai retornar em array associativo
    }
